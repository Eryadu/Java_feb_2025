...
public class GenericClass<C1, C2> {
    C1 name;
    C2 id ;

    // create constructor
    public GenericClass(C1 name, C2 id) {
        this.name = name;
        this.id = id;
    }
    ...
    public static void main(String[] args) {
        ...
        GenericClass< String, Integer> genericClass = new GenericClass<>("ABC", 12); // we pass two data type
